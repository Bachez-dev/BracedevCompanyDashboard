      ...
      <div class="left--side--nav">
        ...
        <div id="Teammates" class="page" style="display: none;">
          <div class="team-head-add">
            <div class="team-head" style="width: 100px; height:100%; display: flex; align-items: center;">
              <h2>Team</h2>
            </div>
            <h2>Meet Our Team</h2>
            <div class="add-btn">
              <button onclick="navigatePages('Settings', this)"><i class="material-icons">groups</i> Add</button>
            </div>
          </div>
              ...
              <div class="team-card">
                <div class="team-card-header">
                  <div class="team-image">
                    <img src="./Svg/user-solid.svg" alt="Team Member" width="20px" height="20px">
                  </div>
                  <div class="team-name-position">
                    <h4>Bradley Cooper</h4>
                    <p style="font-size: 13px; color: #afadadff; margin-top:9px;">Software Engineer</p>
                  </div>
                </div>

                <div class="team-card-details">
                  <div class="member-email">
                    <img src="./Svg/mail_53dp_666666_FILL0_wght400_GRAD0_opsz48.svg" alt="" width="20px" height="20px">
                    <p>bradleycooper@gmail.com</p>
                  </div>
                  <div class="member-phone">
                    <img src="./Svg/phone_in_talk_53dp_666666_FILL0_wght400_GRAD0_opsz48.svg" alt="" width="20px" height="20px">
                    <p>+254 768767902</p>
                  </div>
                  <div class="member-salary">
                    <img src="./Svg/attach_money_53dp_666666_FILL0_wght400_GRAD0_opsz48.svg" alt="" width="20px" height="20px">
                    <p>$50,000</p>
                  </div>
                </div>
              </div>
